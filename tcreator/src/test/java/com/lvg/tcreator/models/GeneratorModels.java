...
public class GeneratorModels {
    ...
    public static QuestionDB getQuestionDB(){
        ...
        questionDB.setQuestionNumber(1);
        questionDB.setTestTypes(TestTypes.TOTAL_TEST);
        questionDB.setQuestionText("Question 1");
